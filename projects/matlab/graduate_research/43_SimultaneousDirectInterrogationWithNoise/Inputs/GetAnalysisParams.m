...
analysis_params.n_interrogation_points = 8000;
...
analysis_params.measurement_snr = -10;

% Turn on to use the matchted filter to clean up network output
analysis_params.use_matched_filter = true;
