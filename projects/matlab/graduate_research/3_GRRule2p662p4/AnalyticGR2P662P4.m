...
%
% @param[in] x0 - The lower bound of the definite integral
%
...
%
function [definite_integral] = AnalyticGR2P662P4(x0, x1, a, b, m)
definite_integral = 0;
...
for k = 0:m
    ...
    f0 = a*sin((2*k+1)*b*x0) - (2*k+1)*b*cos((2*k+1)*b*x0);
