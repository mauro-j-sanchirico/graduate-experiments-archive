%% GetPolyCoefsTanh
%
% @breif Returns a polynomial approximation to the hyperbolic tangent
%
% @details Uses the expansion parameters returned by
% GetModifiedExpansionParams and GetAnalysisParams.  Depending on the
% settings made in GetAnalysisParams, can either generate new alpha coefs
% or load them from a pre-made table.
%
% @returns poly_coefs_tanh_modified - The polynomial coefficients
% approximating the hyperbolic tangent on a bounded interval in MATLAB
% ordering (highest power first).
%
